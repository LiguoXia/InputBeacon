...
& (Join-Path $frameworkDirectory 'csc.exe') /nologo /target:winexe /platform:anycpu /warnaserror+ /codepage:65001 /main:InputBeacon.JavaIntegrationTests "/out:$runner" /reference:System.dll /reference:System.Core.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:Accessibility.dll "/win32manifest:$(Join-Path $projectRoot 'app.manifest')" @sources (Join-Path $PSScriptRoot 'JavaIntegrationTests.cs')

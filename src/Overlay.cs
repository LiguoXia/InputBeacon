...
namespace InputBeacon
{
    internal sealed class Overlay : Form
    {
        ...
        private void UpdateFollow()
        {
            ...
            if (!followLifetime.ShouldShow(true, settings.FollowSeconds, true, now))
            {
                if (caretOverlay != null) caretOverlay.Hide();
                return;
            }
        ...
        {
            string diagnostic;
            InputState next = probe.Read(out diagnostic);
